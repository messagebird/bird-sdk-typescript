...
import { getWhatsAppMessage, listWhatsAppMessageEvents, listWhatsAppMessages, sendWhatsAppReadReceipt } from "../generated/sdk.gen.js";
import type { GetWhatsAppMessageData, ListWhatsAppMessageEventsData, ListWhatsAppMessagesData, SendWhatsAppReadReceiptData, WhatsAppEventList, WhatsAppMessage, WhatsAppReadReceipt } from "../generated/types.gen.js";
...
export type WhatsappMarkReadParams = NonNullable<SendWhatsAppReadReceiptData["body"]>;
...
export class WhatsappResourceBase extends Resource {
   ...
   */
  markRead(messageId: string, params: WhatsappMarkReadParams = {}, options?: RequestOptions): APIPromise<WhatsAppReadReceipt> {
    return this.call<WhatsAppReadReceipt>("POST", options, ({ signal, headers }) =>
      sendWhatsAppReadReceipt({ client: this.client, path: { message_id: messageId }, body: params, headers, signal }));
  }
}
