...
/**
 * Values of DestinationRegion known at this SDK version. The wire value is an open
...
export const DestinationRegion = {
  CentralAsiaCaucasus: "central_asia_caucasus",
  CentralEasternEurope: "central_eastern_europe",
  EastAsia: "east_asia",
  LatinAmericaCaribbean: "latin_america_caribbean",
  MiddleEastNorthAfrica: "middle_east_north_africa",
  NordicsBaltics: "nordics_baltics",
...
/** A known DestinationRegion value. */
export type DestinationRegionValue = (typeof DestinationRegion)[keyof typeof DestinationRegion];

/**
 * Values of DestinationSuperRegion known at this SDK version. The wire value is an open
 * string: a value added by a newer server deserializes unchanged, so switch on
 * these with a `default` branch rather than treating the set as closed.
 */
export const DestinationSuperRegion = {
  Americas: "americas",
...
/** A known DestinationSuperRegion value. */
export type DestinationSuperRegionValue = (typeof DestinationSuperRegion)[keyof typeof DestinationSuperRegion];

/**
 * Values of EmailClientFamily known at this SDK version. The wire value is an open
 * string: a value added by a newer server deserializes unchanged, so switch on
 * these with a `default` branch rather than treating the set as closed.
 */
export const EmailClientFamily = {
  Aol: "aol",
  ...
  Gmx: "gmx",
  Hey: "hey",
  Ionos1and1: "ionos_1and1",
  Laposte: "laposte",
  MailRu: "mail_ru",
  Orange: "orange",
  Outlook: "outlook",
  Protonmail: "protonmail",
  SamsungEmail: "samsung_email",
  Sfr: "sfr",
...
/** A known EmailClientFamily value. */
export type EmailClientFamilyValue = (typeof EmailClientFamily)[keyof typeof EmailClientFamily];

/**
 * Values of EmailClientPlatform known at this SDK version. The wire value is an open
 * string: a value added by a newer server deserializes unchanged, so switch on
 * these with a `default` branch rather than treating the set as closed.
 */
export const EmailClientPlatform = {
  Android: "android",
  DesktopWebmail: "desktop_webmail",
  Ios: "ios",
  Macos: "macos",
  MobileWebmail: "mobile_webmail",
  OutlookCom: "outlook_com",
  Windows: "windows",
  WindowsMail: "windows_mail",
} as const;

/** A known EmailClientPlatform value. */
export type EmailClientPlatformValue = (typeof EmailClientPlatform)[keyof typeof EmailClientPlatform];

/**
 * Values of EmailCompatibilityRuleID known at this SDK version. The wire value is an open
 * string: a value added by a newer server deserializes unchanged, so switch on
 * these with a `default` branch rather than treating the set as closed.
 */
export const EmailCompatibilityRuleID = {
  CssAtImport: "css_at_import",
  CssDisplayFlexGrid: "css_display_flex_grid",
  CssMathFunctions: "css_math_functions",
  CssModernColor: "css_modern_color",
  CssPositionFixedSticky: "css_position_fixed_sticky",
  CssVariablesNoFallback: "css_variables_no_fallback",
  CssViewportUnits: "css_viewport_units",
  HtmlButton: "html_button",
  HtmlEmbeddedContent: "html_embedded_content",
  HtmlEventHandlers: "html_event_handlers",
  HtmlForm: "html_form",
  HtmlLinkedStylesheet: "html_linked_stylesheet",
  HtmlMedia: "html_media",
  HtmlScript: "html_script",
  HtmlSvg: "html_svg",
  HtmlWebPageMarkup: "html_web_page_markup",
} as const;

/** A known EmailCompatibilityRuleID value. */
...
/**
 * Values of EmailTemplateTheme known at this SDK version. The wire value is an open
 * string: a value added by a newer server deserializes unchanged, so switch on
 * these with a `default` branch rather than treating the set as closed.
 */
export const EmailTemplateTheme = {
  Arcane: "arcane",
  Barebone: "barebone",
  Matte: "matte",
  Protocol: "protocol",
...
/** A known EmailTemplateTheme value. */
 ...
 * these with a `default` branch rather than treating the set as closed.
 */
export const VoicePartyEndpointType = {
  BridgePstn: "bridge_pstn",
  BridgeSip: "bridge_sip",
  Pstn: "pstn",
  Sip: "sip",
  Voicemail: "voicemail",
  Webhook: "webhook",
